...
const whiskeyList = [
  ...
  { 
    name: "글렌피딕", 
    reviews: [
      { content: "부드럽고 고급스러운 향과 맛이 좋습니다.", user: realUsers[1] },
...
// 리스트 컴포넌트
function List() {
  const [reviews, setReviews] = useState(whiskeyList.map(whiskey => ({...whiskey, reviewInput: "", user: null, showAllReviews: false})));
